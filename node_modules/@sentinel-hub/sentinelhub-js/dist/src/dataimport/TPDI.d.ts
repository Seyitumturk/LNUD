...
export declare let TPDI_SERVICE_URL: string;
export declare function setTPDIServiceBaseURL(baseurl: string): void;
export declare class TPDI {
    ...
    static getThumbnail(collectionId: TPDICollections, productId: string, planetApiKey?: string, reqConfig?: RequestConfiguration): Promise<Blob>;
