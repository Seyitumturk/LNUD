...
import { ApiType, DataProductId, FindTilesAdditionalParameters, GetMapParams, GetStatsParams, Interpolator, Link, MosaickingOrder, PaginatedTiles, Stats } from './const';
