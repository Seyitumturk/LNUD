...
export declare function wmsWmtMsGetMapUrl(baseUrl: string, layers: string, params: GetMapParams, evalscript?: string | null, evalscriptUrl?: string | null, evalsource?: string | null, additionalParameters?: Record<string, any>): string;
