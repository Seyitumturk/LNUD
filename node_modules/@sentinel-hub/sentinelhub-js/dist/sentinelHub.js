...
function fetchLayerParamsFromConfigurationService(shServiceHostName, instanceId, reqConfig) {
    return __awaiter(this, void 0, void 0, function* () {
...
class AbstractSentinelHubV3Layer extends AbstractLayer {
    ...
    fetchLayerParamsFromSHServiceV3(reqConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const layersParams = yield fetchLayerParamsFromConfigurationService(this.getSHServiceRootUrl(), this.instanceId, reqConfig);
    ...
    findTilesUsingSearchIndex(searchIndexUrl_1, bbox_1, fromTime_1, toTime_1) {
        return __awaiter(this, arguments, void 0, function* (searchIndexUrl, bbox, fromTime, toTime, maxCount = null, offset = null, reqConfig, findTilesAdditionalParameters) {
            if (maxCount === null) {
...
class BYOCLayer extends AbstractSentinelHubV3Layer {
    constructor({ instanceId = null, layerId = null, evalscript = null, evalscriptUrl = null, dataProduct = null, title = null, description = null, collectionId = null, locationId = null, subType = null, shServiceRootUrl = SH_SERVICE_ROOT_URL.default, }) {
...
class LayersFactory {
    ...
    static makeLayers(baseUrl_1) {
        return __awaiter(this, arguments, void 0, function* (baseUrl, filterLayers = null, overrideConstructorParams, reqConfig, preferGetCapabilities = true) {
    ...
    static makeLayersSHv3(baseUrl_1, filterLayers_1, overrideConstructorParams_1, reqConfig_1) {
        return __awaiter(this, arguments, void 0, function* (baseUrl, filterLayers, overrideConstructorParams, reqConfig, preferGetCapabilities = true) {
    ...
    static getSHv3LayersInfo(baseUrl_1, reqConfig_1, filterLayers_1) {
        return __awaiter(this, arguments, void 0, function* (baseUrl, reqConfig, filterLayers, preferGetCapabilities = true) {
            let layersInfos;
            ...
            if (authToken && preferGetCapabilities === false) {
                try {
                    const layers = yield fetchLayerParamsFromConfigurationService(getSHServiceRootUrlFromBaseUrl(baseUrl), parseSHInstanceId(baseUrl), reqConfig);
...
(function (PlanetARPSId) {
    ...
    PlanetARPSId["PS_ARD_SR_BIWEEKLY"] = "PS_ARD_SR_BIWEEKLY";
    PlanetARPSId["PS_ARD_SR_MONTHLY"] = "PS_ARD_SR_MONTHLY";
...
var PlanetPVId;
(function (PlanetPVId) {
    PlanetPVId["BIOMASS_PROXY_V3_0_10"] = "BIOMASS-PROXY_V3.0_10";
